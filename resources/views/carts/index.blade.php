            ...
            <div class="col-lg-12 mb-lg-0 mb-4">
                <div class="card z-index-2 h-100">
                    <div class="card-header pb-0 pt-3 bg-transparent">
                        <h6 class="text-capitalize text-center">Daftar Barang</h6>
                    </div>
                                        ...
                                        @if ($barangs->count() == 0)
                                            <tr>
                                                <td class="align-middle text-center" colspan="7">
                                                    <p class="text-xl font-weight mb-0"> Barang Masih Kosong <a href="{{ route('barangs.create') }}" class="btn btn-success mb-0 px-2 py-2">Tambahkan</a> terlebih dahulu.</p>
                                                </td>
                                            </tr>
                                        @else
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="align-middle text-center" colspan="4">
                                                <p class="text-xl font-weight mb-0">Isi Keranjang terlebih Dahulu</p>
                                            </td>
                                        </tr>
                                        @else
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    ...
                                                    <form action="{{ route('cart.update') }}" method="POST">
                                                        ...
                                                        <div class="row justify-content-center align-items-center">
                                                            <div class="col-9">
                                                                <input type="number" minlength="1" name="quantity" value="{{ $item->quantity }}"
                                                ...
                                                <td class="align-middle text-center">
                                                    ...
                                                    <form action="{{ route('cart.remove') }}" method="POST">
                                                        ...
                                                        <button class="btn btn-warning px-2 py-1 mb-0"  onclick="return confirm('Yakin ingin menghapusnya ?')">Hapus</button>
                                                    </form>
                                                    </p>
                                                </td>
                                            </tr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 d-flex flex-row-reverse">
                                    <form action="{{ route('cart.clear') }}" method="POST">
                                        @csrf
                                        <button class="btn btn-danger mt-1 mb-0"  onclick="return confirm('Yakin ingin menghapus semua barang?')">Hapus Semua Barang</button>
                                    </form>
                                </div>
                            </div>
                        </div>
